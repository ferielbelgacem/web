<?PHP
//include "../config.php";
require  "../core/stockC.php";
$StockC=new StockC();
if(!(isset($_GET['recherche']))){
$listeEmploye=$StockC->afficherStock();
$listeEmploye1=$StockC->afficherStock();
}
else{
	
	$listeEmploye=$StockC->Recherchestock($_GET['recherche']);
	$listeEmploye1=$StockC->afficherStock();
        ...
        <div class="row">
          ...
          <div class="col-lg ds">
            ...
            <div class="donut-main">
            	<form method="get" action="Recherchestock.php">
<div class="form-row">
...
?>
    ...
    </div> <button type="submit" class="btn btn-success">Rechercher</button>
            	</form>
