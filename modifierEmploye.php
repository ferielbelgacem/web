...
<body>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputEmail4" value="<?PHP echo $id_article ?>" name="id_article" placeholder="id_article">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">type</label>
      <input type="text" class="form-control" id="inputPassword4" value="<?PHP echo $type ?>" name="type" placeholder="type">
    </div>
  </div>
  </div>
